...
const GALLERY_ITEMS = [
  {
    ...
    caption: 'Eksplorasi komposisi fotografi vertikal dengan pencahayaan alami dan perspektif dinamis di ruang publik.',
    aspectRatio: '9 / 16',
    ratioLabel: '9:16',
  ...
  },
  {
    id: 3,
    category: 'Creative',
    title: 'Desain ID Card Kepanitiaan',
    caption: 'Perancangan identitas kartu tanda pengenal panitia dengan tipografi modern dan tata letak visual yang presisi.',
    aspectRatio: '4 / 3',
    ratioLabel: '4:3',
    src: '/gallery/design id card 4_3.png',
    alt: 'Desain ID Card 4:3',
  },
  {
    id: 4,
    category: 'Events',
  ...
  },
  {
    ...
    alt: 'Banner Sidang Meja Hijau 1:1',
  },
  {
    id: 8,
    category: 'Events',
    ...
    alt: 'Pengabdian Mengajar Komputer di PKBM Bintula 16:9',
  },
  {
    id: 9,
    category: 'Events',
